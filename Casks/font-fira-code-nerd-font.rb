cask "font-fira-code-nerd-font" do
  version "3.1.1"
  sha256 "60fda8c73acd0d2ded3763f12ae5a2838e07229c6d6f466ddc04e60ad46826b8"

  url "https://github.com/cawaltrip/nerd-fonts/releases/download/v#{version}/FiraCode.zip"
  name "FiraCode Nerd Font (Fira Code)"
  desc "Developer targeted fonts with a high number of glyphs (incl. Battery Nerd)"
  homepage "https://github.com/cawaltrip/nerd-fonts"
